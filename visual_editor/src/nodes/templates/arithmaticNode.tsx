...
const ueBlueprintNode = css<{ selected?: boolean }>`
    ...
    width: auto;
    height: auto;
    display: inline-block; /* so it shrinks/grows to its content */
    ...
    .title {
        background: linear-gradient(180deg, #6395ff 0%, #1f5eff 100%);
        color: #e9f1ff;
        font-weight: 700;
    ...
    ${(p) =>
            ...
            css`
                border-color: #5ac8ff;
                box-shadow:
                        0 0 0 1px rgba(90, 200, 255, 0.8),
                        0 0 18px rgba(90, 200, 255, 0.35),
                        inset 0 1px 0 rgba(255, 255, 255, 0.08);
            `}
`;

export function ArithmaticNode(props: any) {
