...
const ueBlueprintNode = css<{ selected?: boolean }>`
    ...
    .title {
        background: linear-gradient(180deg, #ffb84e 0%, #755000 100%);
        color: #e9f1ff;
        font-weight: 700;
    ...
    ${(p) =>
            ...
            css`
                border-color: #efff5a;
                box-shadow: 0 0 0 1px rgba(255, 253, 108, 0.8),
                0 0 18px rgba(255, 242, 203, 0.35),
                inset 0 1px 0 rgba(255, 255, 255, 0.08);
            `}
`;

export function LogicNode(props: any) {
